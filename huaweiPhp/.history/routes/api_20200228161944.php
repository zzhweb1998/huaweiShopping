...
Route::any('/shop/newOrders','Api\shopping@newOrders');
Route::any('/shop/submitGoods','Api\shopping@submitGoods');
Route::any('/shop/allOD','Api\shopping@allOD');
Route::any('/shop/allOG','Api\shopping@allOG');
Route::any('/shop/ordersPay','Api\shopping@ordersPay');