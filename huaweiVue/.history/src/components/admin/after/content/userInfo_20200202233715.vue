<template>
    <div id="userInfo">
        ...
        <div class="ac-table">
            ...
            <el-pagination background layout="prev, pager, next" :total="pageTotal" :page-size="2"
    ...
    export default {
        ...
        created() {
            this.axios.post("/api/shop/user", {
                ...
                if (this.pageTotal < this.pageSize || this.pageTotal == this.pageSize) {
                    this.pageShow[0] = this.showData.slice(this.pageSize * 0, this.pageTotal)
                } else {
