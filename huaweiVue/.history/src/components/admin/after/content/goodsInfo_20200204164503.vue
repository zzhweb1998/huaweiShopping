        ...
        <div class="ac-table">
            <table border="1" cellspacing="0" cellpadding="0">
                ...
                <tr v-for="(ps,index) in pageShow[pageCurrent]" :key="index">
                    ...
                    <td>
                        <p v-for="(gs,index) in goodsStatus" :key="index" v-show="gs.no == ps.goods_info_status">{{gs.status}}</p>
                    </td>
                    <td>
                        <button class="ac-operate" @click="updatePage">修改</button>
                        <button class="ac-operate" @click="queryPage(ps.goods_info_id)">查询</button>
                    </td>
                </tr>
            </table>
