    ...
    <div id="manageCarousel">
        ...
        <div class="mc-box">
            <div class="mc-operate">
                ...
                <form action="" method="post" enctype="multipart/form-data" target="hide_iframe">
                    <input type="text" name="order" v-model="carouselOrder" v-if="false">
                    <input type="submit" ref="upload" v-if="false">
                    <div>
                        <span>轮播顺序：</span>
                    ...
                    <div>
                        <span>商 品 ID ：</span>
                        <input type="text" name="order" v-model="carouselGoods">
                    </div>
                </form>
                ...
                res.data.filter(item => {
                    this.carouselInfo.filter((item2,index) => {
                        if(item2.id == item.carousel_id){
                            this.carouselInfo[index].name = item.carousel_name
                            this.carouselInfo[index].min = item.min_carousel
...
<style>
    ...
    .mc-operate>form>div input[type=text]{
        width: 80px;
        height: 40px;
    }
    .mc-operate>button{
