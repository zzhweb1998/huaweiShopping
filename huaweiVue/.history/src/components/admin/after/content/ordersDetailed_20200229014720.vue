            ...
            <div class="od-goods">
                <div class="goods-content" v-for="(og,index) in ordersGoods" :key="index">
                    ...
                    <div>
                        ...
                        <p v-if="ordersInfo.orders_status == 4 && og.shopcar_status == 4" class="queryCon">申请退款</p>
                        <p v-if="ordersInfo.orders_status == 4 && og.shopcar_status == 5">取消退款</p>
                        <p v-if="ordersInfo.orders_status == 4 && og.shopcar_status == 6">退款失败</p>
                        <p v-if="ordersInfo.orders_status == 4 && og.shopcar_status == 8" class="queryCon">退款成功</p>
