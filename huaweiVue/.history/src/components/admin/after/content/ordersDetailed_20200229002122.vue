    ...
    <div id="ordersDetailed">
        ...
        <div class="od-buttom">
            ...
            <div class="od-status">
                ...
                <button v-if="ordersInfo.orders_status == 3" @click="cancel">取消订单</button>
                <button v-if="ordersInfo.orders_status == 3" @click="cancel">取消订单</button>
