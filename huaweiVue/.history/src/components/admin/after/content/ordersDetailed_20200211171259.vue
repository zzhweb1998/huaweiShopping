    ...
    <div id="ordersDetailed">
        ...
        <div class="od-top">
            <div class="od-address">
                ...
                <p>详细地址：{{ordersInfo.address_province}} {{ordersInfo.address_city}} {{ordersInfo.address_district}} {{ordersInfo.address_detailed}} aaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</p>
            </div>
