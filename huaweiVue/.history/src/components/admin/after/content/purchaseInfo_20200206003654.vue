    ...
    <div id="purchaseInfo">
        ...
        <div class="ac-search">
            ...
            <div class="operate-box" v-show="revokeShow>0">
                ...
                <button v-show="revokeShow==1">撤销</button>
            </div>
        </div>
        <div class="ac-table">
            <table border="1" cellspacing="0" cellpadding="0">
                ...
                <tr v-for="(ps,index) in pageShow[pageCurrent]" :key="index">
                    ...
                    <td>
                        <button class="ac-operate" v-if="ps.purchase_status == 1" @click="revokeOperate(ps.purchase_id)">撤销</button>
                        <button class="ac-operate" v-if="ps.purchase_status == 0" @click="revokeSee(ps.purchase_id)">查看</button>
                    </td>
                </tr>
            </table>
