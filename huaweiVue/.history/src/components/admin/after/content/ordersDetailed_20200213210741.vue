        ...
        <div class="od-buttom">
            ...
            <div class="od-status">
                <div>
                    ...
                    <p>
                        <span>优惠金额：</span>
                        <span>-￥{{ordersInfo.orders_discount * 0.02 * ordersInfo.total_price}}</span>
                    </p>
                    <p>
                        <span>结算总金额：</span>
                        <span>￥{{ordersInfo.total_price - (ordersInfo.orders_discount * 0.02 * ordersInfo.total_price)}}</span>
                    </p>
                </div>
            </div>
        </div>
