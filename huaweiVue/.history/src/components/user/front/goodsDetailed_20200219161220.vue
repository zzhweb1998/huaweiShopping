            ...
            <div class="gd-bLeft">
                <div class="gd-browseBox">
                    ...
                    <div class="browse-min">
                        <div class="min-box">
                            <div v-for="(bp,index) in browsePicture">
    ...
    export default{
        ...
        created(){
            ...
            this.axios.post("/api/shop/selectGD",{
                ...
                this.showNo = this.goodsDetailed[0].goods_no
                this.colorIndex = this.goodsDetailed[0].goods_color
                this.configureIndex = this.goodsDetailed[0].goods_configure
