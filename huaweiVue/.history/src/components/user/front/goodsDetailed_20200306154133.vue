        ...
        <div class="gd-box">
            ...
            <div class="gd-bRight">
                ...
                <div class="br-operate">
                    ...
                    <button class="operate-shopcar" @click="shopcarAdd" v-if="goodsInfo.stock_num > 0">加入购物车</button>
                    <button class="operate-orders" @click="submitOrders" v-if="goodsInfo.stock_num > 0">立即下单</button>
