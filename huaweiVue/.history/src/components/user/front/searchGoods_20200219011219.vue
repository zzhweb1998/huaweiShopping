    ...
    export default {
        ...
        methods: {
            ...
            screenData() {
                ...
                if (this.sortIndex != 0) {
                    if (this.sortIndex == 1) {
                        this.showData.sort(dropSort('goods_info_id'))
                    } else if (this.sortIndex == 2) {
                        this.showData.sort(dropSort('sales_volume'))
                    } else if (this.sortIndex == 3) {
                        if(this.sortIf == 1){
                            this.showData.sort(riseSort('goods_price'))
                        }else if(this.sortIf == 2){
                            this.showData.sort(dropSort('goods_price'))
                        }
                    }
                }
            },
