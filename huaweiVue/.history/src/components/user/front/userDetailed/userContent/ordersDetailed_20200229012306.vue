<template>
    <div id="ordersDetailed">
            ...
            <div class="od-goods">
                <div class="goods-content" v-for="(og,index) in ordersGoods" :key="index">
                    ...
                    <div>
                        ...
                        <button v-if="ordersInfo.orders_status == 4 && og.shopcar_status == 3" 
                        @click="applyRefund(ordersInfo.orders_no,og.goods_info_name)">申请退款</button>
        ...
        <div class="refund-box" v-show="refundIf == 1">
            <div>
                <p>申请退货订单号：{{refundInfo.no}} &nbsp;&nbsp;&nbsp;&nbsp; 退货商品：{{refundInfo.goods}}</p>
