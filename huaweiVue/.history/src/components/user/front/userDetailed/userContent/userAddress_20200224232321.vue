...
<style>
    ...
    .addressOperate>div:nth-of-type(n+4){
        width: 300px;
        height: 40px;
    }
    .addressOperate>div:nth-of-type(n+4)>button{
        width: 120px;
        height: 40px;
    ...
    .addressOperate>div:nth-of-type(n+4)>button:nth-of-type(1){
        background: #f99c11;
    }
    .addressOperate>div:nth-of-type(n+4)>button:nth-of-type(1):hover{
        background: #e88b00;
    }
    .addressOperate>div:nth-of-type(n+4)>button:nth-of-type(2){
        background: #f5f5f5;
    }
    .addressOperate>div:nth-of-type(n+4)>button:nth-of-type(2):hover{
        background: #eee;
    }
