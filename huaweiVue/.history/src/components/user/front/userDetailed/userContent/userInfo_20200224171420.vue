    ...
    <div id="userInfo">
        ...
        <div class="userOperate">
            <div class="amPage" v-show="amShow == 1">
                ...
                <button @click="amClick">冲值</button>
            </div>
            <div class="pwPage" v-show="pwShow == 1">
                ...
                <button @click="pwClick">修改</button>
            </div>
            <div class="payPage" v-show="payShow == 1 && payIf == 1">
                ...
                <button @click="payClick">修改</button>
            </div>
...
<script>
    export default {
        ...
        methods: {
            ...
            amClick() {
                let amIf = confirm('是否确定冲值')
                if (amIf == true) {

                }
            },
            pwClick() {
                let pwIf = confirm('是否确定修改登陆密码')
                if (pwIf == true) {
            ...
            payClick() {
                if (this.payIf == 1) {
                    let payIf = confirm('是否确定修改支付密码')
                    if (payIf == true) {

                    }
                } else {
                    let payIf = confirm('是否确定设置为支付密码')
                    if (payIf == true) {
