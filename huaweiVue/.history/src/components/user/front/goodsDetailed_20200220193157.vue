                ...
                <div class="gd-bRight">
                    ...
                    <div class="br-operate">
                        <div class="operate-numBox">
                            <input type="number" step="1" @change="numIf" class="nb-input">
...
<style>
    ...
    .operate-numBox>input[type=number]::-webkit-inner-spin-button,
    .operate-numBox>input[type=number]::-webkit-outer-spin-button {
