<template>
    <div id="frontHeader">
        ...
        <div class="fh-right">
            ...
            <span @click="user" v-show="loginIf==1" @mouseover="over" @mouseleave="leave">{{userAccount}}</span>
            <span @click="shopcar">购物车</span>
            <span @click="orders">订单</span>
            <div class="ui-Box" v-show="infoIf == 1" @mouseover="over" @mouseleave="leave">
                <div></div>
                <div class="ui-content">
                    <p>账号：{{userInfo.user_account}}</p>
                    <p>余额：￥{{userInfo.user_money}}</p>
