        ...
        <div class="ac-table">
            <table border="1" cellspacing="0" cellpadding="0">
                ...
                <tr v-for="(ps,index) in pageShow[pageCurrent]" :key="index">
                    ...
                    <td>{{ps.user_email}}</td>
                    <td>
                        <button class="ac-operate" @click="updatePage(ps.user_account)" v-if="adminAccount == ps.user_account || adminAccount == 'admin'">修改</button>
                        <button class="ac-operate" @click="detele(ps.user_account)" v-if="ps.user_id != 1 && adminAccount == 'admin'">注销</button>
                    </td>
                </tr>
            </table>
